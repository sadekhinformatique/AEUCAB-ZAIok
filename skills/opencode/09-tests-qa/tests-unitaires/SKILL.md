...
description: Utiliser cette skill pour : Écrire des tests unitaires ciblés sur la logique métier, isolés des dépendances externes. S'applique aux projets web/mobile (catégorie « Tests & QA » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « tests unitaires ».
---
...
## Objectif
Écrire des tests unitaires ciblés sur la logique métier, isolés des dépendances externes.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « tests unitaires »
- La tâche en cours implique écrire des tests unitaires ciblés sur la logique métier, isolés des dépendances externes
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « tests unitaires », adaptée au projet en cours
