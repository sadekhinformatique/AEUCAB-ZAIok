---
name: detection-incoherences
description: Utiliser cette skill pour : Repérer les incohérences (nommage, structure, comportements différents pour des cas similaires). S'applique aux projets web/mobile (catégorie « Analyse automatique » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « détection des incohérences ».
---
...
## Objectif
Repérer les incohérences (nommage, structure, comportements différents pour des cas similaires).

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « détection des incohérences »
- La tâche en cours implique repérer les incohérences (nommage, structure, comportements différents pour des cas similaires)
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « détection des incohérences », adaptée au projet en cours
