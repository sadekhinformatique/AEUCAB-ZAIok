---
name: analyse-seo-auto
description: Utiliser cette skill pour : Auditer un site existant sur les critères SEO techniques et de contenu. S'applique aux projets web/mobile (catégorie « Analyse automatique » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « analyse seo (automatique) ».
---
...
## Objectif
Auditer un site existant sur les critères seo techniques et de contenu.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « analyse seo (automatique) »
- La tâche en cours implique auditer un site existant sur les critères seo techniques et de contenu
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « analyse seo (automatique) », adaptée au projet en cours
