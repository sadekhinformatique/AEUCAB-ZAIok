---
name: abonnement
description: Utiliser cette skill pour : Concevoir le cycle de vie d'un abonnement (essai, actif, impayé, résilié) de façon robuste. S'applique aux projets web/mobile (catégorie « SaaS » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « abonnement ».
---
...
## Objectif
Concevoir le cycle de vie d'un abonnement (essai, actif, impayé, résilié) de façon robuste.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « abonnement »
- La tâche en cours implique concevoir le cycle de vie d'un abonnement (essai, actif, impayé, résilié) de façon robuste
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « abonnement », adaptée au projet en cours
