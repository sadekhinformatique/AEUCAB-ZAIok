---
name: vercel
description: Utiliser cette skill pour : Déployer et configurer une application (Next.js notamment) sur Vercel : env, domaines, previews. S'applique aux projets web/mobile (catégorie « Déploiement » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « vercel ».
---
...
## Objectif
Déployer et configurer une application (next.js notamment) sur vercel : env, domaines, previews.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « vercel »
- La tâche en cours implique déployer et configurer une application (next.js notamment) sur vercel
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « vercel », adaptée au projet en cours
