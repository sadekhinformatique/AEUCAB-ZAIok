...
description: Utiliser cette skill pour : Gérer l'upload, le stockage, la validation et la diffusion de fichiers (taille, type, sécurité) de façon sûre. S'applique aux projets web/mobile (catégorie « Backend » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « gestion des fichiers ».
---
...
## Objectif
Gérer l'upload, le stockage, la validation et la diffusion de fichiers (taille, type, sécurité) de façon sûre.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « gestion des fichiers »
- La tâche en cours implique gérer l'upload, le stockage, la validation et la diffusion de fichiers (taille, type, sécurité) de façon sûre
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « gestion des fichiers », adaptée au projet en cours
