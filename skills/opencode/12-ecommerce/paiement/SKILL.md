---
name: paiement
description: Utiliser cette skill pour : Intégrer un prestataire de paiement (Stripe, etc.) de façon sécurisée, sans manipuler les données de carte. S'applique aux projets web/mobile (catégorie « E-commerce » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « paiement ».
---
...
## Objectif
Intégrer un prestataire de paiement (stripe, etc.) de façon sécurisée, sans manipuler les données de carte.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « paiement »
- La tâche en cours implique intégrer un prestataire de paiement (stripe, etc.) de façon sécurisée, sans manipuler les données de carte
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « paiement », adaptée au projet en cours
