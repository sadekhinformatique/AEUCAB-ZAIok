...
description: Utiliser cette skill pour : Synthétiser les constats d'analyse en recommandations claires, priorisées et actionnables. S'applique aux projets web/mobile (catégorie « Analyse automatique » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « recommandations ».
---
...
## Objectif
Synthétiser les constats d'analyse en recommandations claires, priorisées et actionnables.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « recommandations »
- La tâche en cours implique synthétiser les constats d'analyse en recommandations claires, priorisées et actionnables
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « recommandations », adaptée au projet en cours
