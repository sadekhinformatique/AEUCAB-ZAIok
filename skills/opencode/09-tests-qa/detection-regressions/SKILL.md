---
name: detection-regressions
description: Utiliser cette skill pour : Mettre en place des tests de non-régression pour sécuriser les évolutions futures du projet. S'applique aux projets web/mobile (catégorie « Tests & QA » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « détection des régressions ».
---
...
## Objectif
Mettre en place des tests de non-régression pour sécuriser les évolutions futures du projet.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « détection des régressions »
- La tâche en cours implique mettre en place des tests de non-régression pour sécuriser les évolutions futures du projet
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « détection des régressions », adaptée au projet en cours
