---
name: lazy-loading
description: Utiliser cette skill pour : Mettre en place le chargement différé des images, composants et routes non immédiatement nécessaires. S'applique aux projets web/mobile (catégorie « Performance » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « lazy loading ».
---
...
## Objectif
Mettre en place le chargement différé des images, composants et routes non immédiatement nécessaires.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « lazy loading »
- La tâche en cours implique mettre en place le chargement différé des images, composants et routes non immédiatement nécessaires
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « lazy loading », adaptée au projet en cours
