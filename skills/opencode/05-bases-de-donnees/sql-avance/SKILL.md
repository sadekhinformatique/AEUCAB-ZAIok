---
name: sql-avance
description: Utiliser cette skill pour : Écrire des requêtes SQL complexes (jointures, sous-requêtes, agrégations, window functions) lisibles et performantes. S'applique aux projets web/mobile (catégorie « Bases de données » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « sql avancé ».
---
...
## Objectif
Écrire des requêtes sql complexes (jointures, sous-requêtes, agrégations, window functions) lisibles et performantes.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « sql avancé »
- La tâche en cours implique écrire des requêtes sql complexes (jointures, sous-requêtes, agrégations, window functions) lisibles et performantes
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « sql avancé », adaptée au projet en cours
