---
name: environnements-staging-production
description: Utiliser cette skill pour : Mettre en place des environnements staging et production cohérents pour valider avant mise en ligne. S'applique aux projets web/mobile (catégorie « DevOps » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « environnements staging/production ».
---
...
## Objectif
Mettre en place des environnements staging et production cohérents pour valider avant mise en ligne.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « environnements staging/production »
- La tâche en cours implique mettre en place des environnements staging et production cohérents pour valider avant mise en ligne
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « environnements staging/production », adaptée au projet en cours
