...
description: Utiliser cette skill pour : Configurer, sécuriser et sauvegarder une base PostgreSQL en environnement de production. S'applique aux projets web/mobile (catégorie « Déploiement » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « postgresql en production ».
---
...
## Objectif
Configurer, sécuriser et sauvegarder une base postgresql en environnement de production.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « postgresql en production »
- La tâche en cours implique configurer, sécuriser et sauvegarder une base postgresql en environnement de production
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « postgresql en production », adaptée au projet en cours
