---
name: indexation
description: Utiliser cette skill pour : Choisir les bons index (simples, composites, uniques) pour accélérer les requêtes sans pénaliser les écritures. S'applique aux projets web/mobile (catégorie « Bases de données » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « indexation ».
---
...
## Objectif
Choisir les bons index (simples, composites, uniques) pour accélérer les requêtes sans pénaliser les écritures.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « indexation »
- La tâche en cours implique choisir les bons index (simples, composites, uniques) pour accélérer les requêtes sans pénaliser les écritures
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « indexation », adaptée au projet en cours
