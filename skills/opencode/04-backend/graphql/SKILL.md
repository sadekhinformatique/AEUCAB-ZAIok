---
name: graphql
description: Utiliser cette skill pour : Concevoir un schéma GraphQL (types, queries, mutations, resolvers) adapté aux besoins du frontend. S'applique aux projets web/mobile (catégorie « Backend » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « graphql ».
---
...
## Objectif
Concevoir un schéma graphql (types, queries, mutations, resolvers) adapté aux besoins du frontend.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « graphql »
- La tâche en cours implique concevoir un schéma graphql (types, queries, mutations, resolvers) adapté aux besoins du frontend
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « graphql », adaptée au projet en cours
