---
name: facturation-ecommerce
description: Utiliser cette skill pour : Générer des factures conformes automatiquement à partir des commandes validées. S'applique aux projets web/mobile (catégorie « E-commerce » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « facturation e-commerce ».
---
...
## Objectif
Générer des factures conformes automatiquement à partir des commandes validées.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « facturation e-commerce »
- La tâche en cours implique générer des factures conformes automatiquement à partir des commandes validées
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « facturation e-commerce », adaptée au projet en cours
