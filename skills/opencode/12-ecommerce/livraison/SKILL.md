---
name: livraison
description: Utiliser cette skill pour : Intégrer la gestion des options et frais de livraison selon zone, poids ou transporteur. S'applique aux projets web/mobile (catégorie « E-commerce » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « livraison ».
---
...
## Objectif
Intégrer la gestion des options et frais de livraison selon zone, poids ou transporteur.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « livraison »
- La tâche en cours implique intégrer la gestion des options et frais de livraison selon zone, poids ou transporteur
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « livraison », adaptée au projet en cours
