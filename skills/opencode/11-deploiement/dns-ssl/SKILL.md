---
name: dns-ssl
description: Utiliser cette skill pour : Configurer les enregistrements DNS et les certificats SSL pour un domaine en production. S'applique aux projets web/mobile (catégorie « Déploiement » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « dns & ssl ».
---
...
## Objectif
Configurer les enregistrements dns et les certificats ssl pour un domaine en production.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « dns & ssl »
- La tâche en cours implique configurer les enregistrements dns et les certificats ssl pour un domaine en production
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « dns & ssl », adaptée au projet en cours
