---
name: dashboard-saas
description: Utiliser cette skill pour : Concevoir le dashboard principal d'un SaaS : indicateurs clés, actions rapides, état du compte. S'applique aux projets web/mobile (catégorie « SaaS » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « dashboard saas ».
---
...
## Objectif
Concevoir le dashboard principal d'un saas : indicateurs clés, actions rapides, état du compte.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « dashboard saas »
- La tâche en cours implique concevoir le dashboard principal d'un saas
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « dashboard saas », adaptée au projet en cours
