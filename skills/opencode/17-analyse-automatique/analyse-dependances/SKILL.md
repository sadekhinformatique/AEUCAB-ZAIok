...
description: Utiliser cette skill pour : Auditer les dépendances du projet (versions obsolètes, vulnérabilités, packages inutiles). S'applique aux projets web/mobile (catégorie « Analyse automatique » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « analyse des dépendances ».
---
...
## Objectif
Auditer les dépendances du projet (versions obsolètes, vulnérabilités, packages inutiles).

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « analyse des dépendances »
- La tâche en cours implique auditer les dépendances du projet (versions obsolètes, vulnérabilités, packages inutiles)
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « analyse des dépendances », adaptée au projet en cours
