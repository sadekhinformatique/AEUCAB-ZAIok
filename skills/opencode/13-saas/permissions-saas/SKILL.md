---
name: permissions-saas
description: Utiliser cette skill pour : Définir des permissions par rôle et par organisation, vérifiées à chaque action sensible. S'applique aux projets web/mobile (catégorie « SaaS » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « permissions saas ».
---
...
## Objectif
Définir des permissions par rôle et par organisation, vérifiées à chaque action sensible.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « permissions saas »
- La tâche en cours implique définir des permissions par rôle et par organisation, vérifiées à chaque action sensible
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « permissions saas », adaptée au projet en cours
