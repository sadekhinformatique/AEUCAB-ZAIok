---
name: jwt
description: Utiliser cette skill pour : Mettre en place une authentification par JWT : génération, vérification, expiration, refresh tokens. S'applique aux projets web/mobile (catégorie « Backend » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « jwt ».
---
...
## Objectif
Mettre en place une authentification par jwt : génération, vérification, expiration, refresh tokens.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « jwt »
- La tâche en cours implique mettre en place une authentification par jwt
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « jwt », adaptée au projet en cours
