---
name: ci-cd
description: Utiliser cette skill pour : Mettre en place un pipeline CI/CD (build, tests, déploiement automatisé) adapté au projet. S'applique aux projets web/mobile (catégorie « DevOps » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « ci/cd ».
---
...
## Objectif
Mettre en place un pipeline ci/cd (build, tests, déploiement automatisé) adapté au projet.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « ci/cd »
- La tâche en cours implique mettre en place un pipeline ci/cd (build, tests, déploiement automatisé) adapté au projet
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « ci/cd », adaptée au projet en cours
