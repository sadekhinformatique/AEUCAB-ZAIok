---
name: sqlite
description: Utiliser cette skill pour : Utiliser SQLite efficacement pour des applications locales/embarquées (Electron, prototypage) avec ses limites en tête. S'applique aux projets web/mobile (catégorie « Bases de données » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « sqlite ».
---
...
## Objectif
Utiliser sqlite efficacement pour des applications locales/embarquées (electron, prototypage) avec ses limites en tête.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « sqlite »
- La tâche en cours implique utiliser sqlite efficacement pour des applications locales/embarquées (electron, prototypage) avec ses limites en tête
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « sqlite », adaptée au projet en cours
