...
description: Utiliser cette skill pour : Concevoir l'espace client (historique de commandes, adresses, préférences) de façon simple et sécurisée. S'applique aux projets web/mobile (catégorie « E-commerce » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « comptes clients ».
---
...
## Objectif
Concevoir l'espace client (historique de commandes, adresses, préférences) de façon simple et sécurisée.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « comptes clients »
- La tâche en cours implique concevoir l'espace client (historique de commandes, adresses, préférences) de façon simple et sécurisée
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « comptes clients », adaptée au projet en cours
