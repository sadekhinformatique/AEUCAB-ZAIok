---
name: gestion-stocks
description: Utiliser cette skill pour : Gérer les niveaux de stock de façon cohérente, avec alertes de rupture et réservation lors de la commande. S'applique aux projets web/mobile (catégorie « E-commerce » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « gestion des stocks ».
---
...
## Objectif
Gérer les niveaux de stock de façon cohérente, avec alertes de rupture et réservation lors de la commande.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « gestion des stocks »
- La tâche en cours implique gérer les niveaux de stock de façon cohérente, avec alertes de rupture et réservation lors de la commande
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « gestion des stocks », adaptée au projet en cours
