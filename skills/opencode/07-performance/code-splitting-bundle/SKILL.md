---
name: code-splitting-bundle
description: Utiliser cette skill pour : Réduire la taille du bundle JS via code splitting, imports dynamiques et analyse du bundle. S'applique aux projets web/mobile (catégorie « Performance » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « code splitting & optimisation bundle ».
---
...
## Objectif
Réduire la taille du bundle js via code splitting, imports dynamiques et analyse du bundle.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « code splitting & optimisation bundle »
- La tâche en cours implique réduire la taille du bundle js via code splitting, imports dynamiques et analyse du bundle
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « code splitting & optimisation bundle », adaptée au projet en cours
