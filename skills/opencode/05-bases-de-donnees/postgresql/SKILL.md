---
name: postgresql
description: Utiliser cette skill pour : Concevoir et administrer une base PostgreSQL : types, contraintes, index, requêtes avancées. S'applique aux projets web/mobile (catégorie « Bases de données » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « postgresql ».
---
...
## Objectif
Concevoir et administrer une base postgresql : types, contraintes, index, requêtes avancées.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « postgresql »
- La tâche en cours implique concevoir et administrer une base postgresql
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « postgresql », adaptée au projet en cours
