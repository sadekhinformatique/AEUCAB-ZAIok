---
name: netlify
description: Utiliser cette skill pour : Déployer et configurer un site/app sur Netlify : build, redirections, fonctions serverless. S'applique aux projets web/mobile (catégorie « Déploiement » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « netlify ».
---
...
## Objectif
Déployer et configurer un site/app sur netlify : build, redirections, fonctions serverless.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « netlify »
- La tâche en cours implique déployer et configurer un site/app sur netlify
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « netlify », adaptée au projet en cours
