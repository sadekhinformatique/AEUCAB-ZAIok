---
name: django
description: Utiliser cette skill pour : Structurer une application Django (apps, models, vues, serializers) en suivant les conventions du framework. S'applique aux projets web/mobile (catégorie « Backend » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « django ».
---
...
## Objectif
Structurer une application django (apps, models, vues, serializers) en suivant les conventions du framework.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « django »
- La tâche en cours implique structurer une application django (apps, models, vues, serializers) en suivant les conventions du framework
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « django », adaptée au projet en cours
