...
description: Utiliser cette skill pour : Mettre en place des tests de charge/perf pour vérifier le comportement sous forte utilisation. S'applique aux projets web/mobile (catégorie « Tests & QA » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « tests de performance ».
---
...
## Objectif
Mettre en place des tests de charge/perf pour vérifier le comportement sous forte utilisation.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « tests de performance »
- La tâche en cours implique mettre en place des tests de charge/perf pour vérifier le comportement sous forte utilisation
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « tests de performance », adaptée au projet en cours
