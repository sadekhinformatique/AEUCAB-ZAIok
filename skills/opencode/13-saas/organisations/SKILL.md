---
name: organisations
description: Utiliser cette skill pour : Modéliser la notion d'organisation/compte multi-utilisateurs avec propriétaire et membres. S'applique aux projets web/mobile (catégorie « SaaS » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « organisations ».
---
...
## Objectif
Modéliser la notion d'organisation/compte multi-utilisateurs avec propriétaire et membres.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « organisations »
- La tâche en cours implique modéliser la notion d'organisation/compte multi-utilisateurs avec propriétaire et membres
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « organisations », adaptée au projet en cours
