---
name: quotas
description: Utiliser cette skill pour : Implémenter des quotas d'usage vérifiés côté serveur avec messages clairs à l'approche des limites. S'applique aux projets web/mobile (catégorie « SaaS » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « quotas ».
---
...
## Objectif
Implémenter des quotas d'usage vérifiés côté serveur avec messages clairs à l'approche des limites.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « quotas »
- La tâche en cours implique implémenter des quotas d'usage vérifiés côté serveur avec messages clairs à l'approche des limites
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « quotas », adaptée au projet en cours
