...
description: Utiliser cette skill pour : Concevoir le cycle de vie d'une commande (création, statuts, historique) de façon traçable. S'applique aux projets web/mobile (catégorie « E-commerce » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « gestion des commandes ».
---
...
## Objectif
Concevoir le cycle de vie d'une commande (création, statuts, historique) de façon traçable.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « gestion des commandes »
- La tâche en cours implique concevoir le cycle de vie d'une commande (création, statuts, historique) de façon traçable
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « gestion des commandes », adaptée au projet en cours
