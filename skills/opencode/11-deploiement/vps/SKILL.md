---
name: vps
description: Utiliser cette skill pour : Configurer un VPS (accès sécurisé, pare-feu, utilisateurs) pour héberger une application en production. S'applique aux projets web/mobile (catégorie « Déploiement » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « vps ».
---
...
## Objectif
Configurer un vps (accès sécurisé, pare-feu, utilisateurs) pour héberger une application en production.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « vps »
- La tâche en cours implique configurer un vps (accès sécurisé, pare-feu, utilisateurs) pour héberger une application en production
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « vps », adaptée au projet en cours
