---
name: onboarding
description: Utiliser cette skill pour : Concevoir un parcours d'onboarding qui amène rapidement l'utilisateur à sa première valeur. S'applique aux projets web/mobile (catégorie « SaaS » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « onboarding ».
---
...
## Objectif
Concevoir un parcours d'onboarding qui amène rapidement l'utilisateur à sa première valeur.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « onboarding »
- La tâche en cours implique concevoir un parcours d'onboarding qui amène rapidement l'utilisateur à sa première valeur
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « onboarding », adaptée au projet en cours
