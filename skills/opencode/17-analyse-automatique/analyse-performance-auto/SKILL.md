---
name: analyse-performance-auto
description: Utiliser cette skill pour : Identifier les goulets d'étranglement de performance d'une application existante. S'applique aux projets web/mobile (catégorie « Analyse automatique » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « analyse de performance (automatique) ».
---
...
## Objectif
Identifier les goulets d'étranglement de performance d'une application existante.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « analyse de performance (automatique) »
- La tâche en cours implique identifier les goulets d'étranglement de performance d'une application existante
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « analyse de performance (automatique) », adaptée au projet en cours
