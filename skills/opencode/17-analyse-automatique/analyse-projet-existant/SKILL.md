---
name: analyse-projet-existant
description: Utiliser cette skill pour : Faire l'état des lieux complet d'un projet existant (stack, structure, dépendances, dette technique). S'applique aux projets web/mobile (catégorie « Analyse automatique » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « analyse du projet existant ».
---
...
## Objectif
Faire l'état des lieux complet d'un projet existant (stack, structure, dépendances, dette technique).

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « analyse du projet existant »
- La tâche en cours implique faire l'état des lieux complet d'un projet existant (stack, structure, dépendances, dette technique)
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « analyse du projet existant », adaptée au projet en cours
