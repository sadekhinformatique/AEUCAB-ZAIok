...
description: Utiliser cette skill pour : Concevoir un catalogue produits (catégories, variantes, attributs, recherche/filtre) évolutif. S'applique aux projets web/mobile (catégorie « E-commerce » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « catalogue produits ».
---
...
## Objectif
Concevoir un catalogue produits (catégories, variantes, attributs, recherche/filtre) évolutif.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « catalogue produits »
- La tâche en cours implique concevoir un catalogue produits (catégories, variantes, attributs, recherche/filtre) évolutif
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « catalogue produits », adaptée au projet en cours
