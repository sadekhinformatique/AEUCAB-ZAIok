---
name: mysql
description: Utiliser cette skill pour : Concevoir et administrer une base MySQL en tenant compte de ses spécificités (moteurs de stockage, index). S'applique aux projets web/mobile (catégorie « Bases de données » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « mysql ».
---
...
## Objectif
Concevoir et administrer une base mysql en tenant compte de ses spécificités (moteurs de stockage, index).

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « mysql »
- La tâche en cours implique concevoir et administrer une base mysql en tenant compte de ses spécificités (moteurs de stockage, index)
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « mysql », adaptée au projet en cours
