---
name: notifications
description: Utiliser cette skill pour : Concevoir un système de notifications (in-app, email, push) déclenché par des événements métier. S'applique aux projets web/mobile (catégorie « Backend » du pack Web Master AI, stack type Next.js, React Native, Supabase, Django, Electron). Déclencher dès qu'une tâche touche à « notifications ».
---
...
## Objectif
Concevoir un système de notifications (in-app, email, push) déclenché par des événements métier.

## Quand déclencher cette skill
- L'utilisateur demande explicitement de travailler sur « notifications »
- La tâche en cours implique concevoir un système de notifications (in-app, email, push) déclenché par des événements métier
...
## Livrables attendus
- Une solution concrète et fonctionnelle pour « notifications », adaptée au projet en cours
